...
export declare class PersistentDelegationRequestTransaction extends TransferTransaction {
     ...
     */
    static createPersistentDelegationRequestTransaction(deadline: Deadline, delegatedPrivateKey: string, recipientPublicKey: string, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): PersistentDelegationRequestTransaction;
}
