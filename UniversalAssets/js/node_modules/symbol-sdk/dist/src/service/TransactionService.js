...
class TransactionService {
    ...
    resolveAliases(transationHashes) {
        return this.transactionRepository.getTransactionsById(transationHashes, TransactionGroup_1.TransactionGroup.Confirmed).pipe(operators_1.mergeMap((_) => _), operators_1.mergeMap((transaction) => this.resolveTransaction(transaction)), operators_1.toArray());
    }
    /**
