...
class NamespaceHttp extends Http_1.Http {
    ...
    getNamespacesFromAccount(address, queryParams) {
        return this.call(this.namespaceRoutesApi.getNamespacesFromAccount(address.plain(), this.queryParams(queryParams).pageSize, this.queryParams(queryParams).id), (body) => body.namespaces.map((namespaceInfoDTO) => this.toNamespaceInfo(namespaceInfoDTO)));
    }
    /**
    ...
    getNamespacesFromAccounts(addresses) {
        ...
        return this.call(this.namespaceRoutesApi.getNamespacesFromAccounts(publicKeysBody), (body) => body.namespaces.map((namespaceInfoDTO) => this.toNamespaceInfo(namespaceInfoDTO)));
    }
    /**
     ...
     */
    toNamespaceInfo(dto) {
        return new NamespaceInfo_1.NamespaceInfo(dto.meta.active, dto.meta.index, dto.meta.id, dto.namespace.registrationType, dto.namespace.depth, this.extractLevels(dto.namespace), NamespaceId_1.NamespaceId.createFromEncoded(dto.namespace.parentId), Address_1.Address.createFromEncoded(dto.namespace.ownerAddress), UInt64_1.UInt64.fromNumericString(dto.namespace.startHeight), UInt64_1.UInt64.fromNumericString(dto.namespace.endHeight), this.extractAlias(dto.namespace));
    }
